...
function EigenVisualization(X_test,test_label,W,color,row,col,mean)
    % Two demension
    W1=W(:,1:2)';
    ...
    for i=1:samples
        ...
        colormap(gray(256));
        image('CData', picture, 'XData', [Y_test(1,i)-160 Y_test(1,i)-20], 'YData', [Y_test(2,i)-160 Y_test(2,i)+80]);
    end
    
    % Three demension
    figure(2);
    W2=W(:,1:3)';
    Y_test=W2*(X_test-mean);
